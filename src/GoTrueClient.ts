...
export default class GoTrueClient {
  ...
  private async _unenroll(params: MFAUnenrollParams): Promise<AuthMFAUnenrollResponse> {
    return await _request(this.fetch, 'DELETE', `${this.url}/factor/${params.factorId}`, {
  ...
  private async _enroll(params: MFAEnrollParams): Promise<AuthMFAEnrollResponse> {
    return await _request(this.fetch, 'POST', `${this.url}/factor`, {
      body: {
  ...
  private async _verify(params: MFAVerifyParams): Promise<AuthMFAVerifyResponse> {
    const { data, error } = await _request(
      this.fetch,
      'POST',
      `${this.url}/factor/${params.factorId}/verify`,
      {
  ...
  private async _challenge(params: MFAChallengeParams): Promise<AuthMFAChallengeResponse> {
    return await _request(this.fetch, 'POST', `${this.url}/factor/${params.factorId}/challenge`, {
      headers: this.headers,
    })
  }
