...
export default class GoTrueAdminApi {
   ...
   * @param payload.userID The user object's id.
   * @param payload.codeChallenge The hash of a one time password saved on the client.
   * This is generated by `auth.generateCodeChallengeAndMethod`
   * @param payload.codeChallengeMethod The hashing method used during the generation of the code challenge
   */
